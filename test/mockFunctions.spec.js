...
describe('3 - Verifica as funções e os mocks', () => {
  test('testa função add', () => {
    mockFunctions.add = (num1, num2) => num1 + num2;
  ...
  test('testa função subtract', () => {
    mockFunctions.subtract = (num1, num2) => num1 - num2;
  ...
  test('testa função multiply', () => {
    mockFunctions.multiply = (num1, num2) => num1 * num2;
  ...
  test('testa função divide', () => {
    mockFunctions.divide = (num1, num2) => num1 / num2;
  ...
  test('testa função power', () => {
    mockFunctions.power = (num1, num2) => num1 ** num2;
